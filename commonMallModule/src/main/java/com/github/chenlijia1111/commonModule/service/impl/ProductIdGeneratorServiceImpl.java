 ...
 * @since 2019/12/30
 */
public class ProductIdGeneratorServiceImpl implements IdGeneratorServiceI {
    ...
    public String createOrderNo() {
        ...
        lastDay = nowDate;
        String groupId = StringUtils.completeIntToFixedLengthStr("9" + nowDate.format(DateTimeFormatter.ofPattern("yyyyMMdd")), 6, currentNumber.addAndGet(1), '0');
        return groupId;
    }
