 ...
 * @since 2019/12/30
 */
public class FightNoGeneratorServiceImpl implements IdGeneratorServiceI {
    ...
    public String createOrderNo() {
        ...
        lastDay = nowDate;
        String groupId = StringUtils.completeIntToFixedLengthStr("7" + nowDate.format(DateTimeFormatter.ofPattern("yyyyMMdd")), 6, ShoppingIdGeneratorServiceImpl.currentNumber.addAndGet(1), '0');
        return groupId;
    }
