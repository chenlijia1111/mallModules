 ...
 * @since 2019/12/30
 */
public class SpikeOrderNoGeneratorServiceImpl implements OrderIdGeneratorServiceI {
    ...
    public String createOrderNo() {
        ...
        lastDay = nowDate;
        String groupId = StringUtils.completeIntToFixedLengthStr("6" + nowDate.format(DateTimeFormatter.ofPattern("yyyyMMdd")), 6, ShoppingOrderIdGeneratorServiceImpl.currentNumber.addAndGet(1), '0');
        return groupId;
    }
